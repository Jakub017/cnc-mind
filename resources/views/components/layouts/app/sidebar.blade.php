    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        ...
        >
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Start')" class="grid">
                    <flux:navlist.item
                        icon="home"
                        :href="route('dashboard')"
                ...
                >
                    <flux:navlist.item
                        icon="wrench"
                        :href="route('tools')"
                        :current="request()->routeIs('tools')"
                        wire:navigate
                        >{{ __("Tools") }}</flux:navlist.item
                    >
                    <flux:navlist.item
                        icon="cube"
                        :href="route('materials')"
                        :current="request()->routeIs('materials')"
                        wire:navigate
                    ...
                    <flux:navlist.item
                        ...
                        wire:navigate
                        >{{ __("Operations") }}</flux:navlist.item
                    >
                </flux:navlist.group>
            </flux:navlist>
            ...
            <flux:navlist variant="outline">
                <flux:navlist.item
                    icon="folder-git-2"
                    href="https://github.com/Jakub017/cnc-mind"
                    target="_blank"
                >
                    {{ __("Repository") }}
                </flux:navlist.item>
            ...
            <flux:text class="text-xs text-center"
                >{{ config("app.name") }} {{ config("app.version") }}</flux:text
            >
        </flux:sidebar>
