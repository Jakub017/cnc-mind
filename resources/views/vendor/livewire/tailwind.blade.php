                                    ...
                                    <span wire:key="paginator-{{ $paginator->getPageName() }}-page{{ $page }}">
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page">
                                                <span class="cursor-pointer relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-zinc-500 bg-white border border-zinc-300 cursor-default leading-5 dark:bg-zinc-800 dark:border-zinc-600">{{ $page }}</span>
                                            </span>
                                        @else
