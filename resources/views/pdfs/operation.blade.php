...
<body>
    <div class="flex flex-col gap-4 p-4">
        ...
        <div class="bg-zinc-50 dark:bg-zinc-700 flex w-full rounded-lg flex-col gap-2 border dark:border-zinc-600 p-4">
            <flux:heading>
                {{ __('Description') }}
            </flux:heading>
        ...
        @if ($operation->file)
            <div
                ...
                <flux:text>{{ $operation->file->name }}</flux:text>
            </div>
        @endif
        ...
        <div class="flex w-full flex-col gap-4">
            <div class="flex w-full gap-4">
                <div
                    ...
                    <flux:text>{{ $operation->cutting_speed_vc }}
                        {{ __('m/min') }}</flux:text>
                </div>
                <div
                    class="bg-zinc-50 dark:bg-zinc-700 flex w-full md:w-1/3 rounded-lg flex-col gap-2 border dark:border-zinc-600 p-4">
                    ...
                    <flux:text>{{ $operation->spindle_speed_n }}
                        {{ __('rpm') }}</flux:text>
                </div>
                <div
                    class="bg-zinc-50 dark:bg-zinc-700 flex w-full md:w-1/3 rounded-lg flex-col gap-2 border dark:border-zinc-600 p-4">
                    ...
                    <flux:text>{{ $operation->feed_per_tooth_fz }}
            ...
            <div class="flex w-full gap-4">
                <div
                    ...
                    <flux:text>{{ $operation->feed_rate_vf }}
                        {{ __('mm/min') }}</flux:text>
                </div>
                <div
                    class="bg-zinc-50 dark:bg-zinc-700 flex w-full md:w-1/3 rounded-lg flex-col gap-2 border dark:border-zinc-600 p-4">
                    ...
                    <flux:text>{{ $operation->depth_of_cut_ap }}
                        {{ __('mm') }}</flux:text>
                </div>
                <div
                    class="bg-zinc-50 dark:bg-zinc-700 flex w-full md:w-1/3 rounded-lg flex-col gap-2 border dark:border-zinc-600 p-4">
                    ...
                    <flux:text>{{ $operation->width_of_cut_ae }}
                        {{ __('mm') }}</flux:text>
                </div>
            </div>
            @if ($operation->g_code != '')
                <div
                    ...
                    <flux:text>{{ $operation->g_code }}</flux:text>
                </div>
            @endif
            <div
                ...
                <flux:text>{{ $operation->notes }}</flux:text>
            </div>
            <div
                class="bg-zinc-50 dark:bg-zinc-700 flex w-full rounded-lg flex-col gap-2 border dark:border-zinc-600 p-4">
                <flux:heading class="dark:text-white">
